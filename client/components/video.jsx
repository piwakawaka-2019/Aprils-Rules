...
const Video = () => {
  return(
    ...
    <Roll left>
    <div className="">
    <iframe width="90%" height="600" src="https://www.youtube.com/embed/F3nZu5JrLK4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
    </Roll>
    <div>
      <Roll right>
